...
@Component({
  selector: 'app-post-reaction-add',
  imports: [CommonModule, RouterLink, ReactiveFormsModule, InputRowComponent],
  templateUrl: './post-reaction-add.component.html'
})
export class PostReactionAddComponent implements OnInit {
  ...
  getMessage(key: string, details?: any) {
    const messages: Record<string, string> = {
      created: $localize`:@@postReaction.create.success:Post Reaction was created successfully.`
    };
    return messages[key];
  }
  ...
  handleSubmit() {
    ...
    const data = new PostReactionDTO(this.addForm.value);
    this.postReactionService.createPostReaction(data)
        .subscribe({
