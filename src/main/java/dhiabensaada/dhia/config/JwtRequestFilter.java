...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    public JwtRequestFilter(final DhiaUserDetailsService dhiaUserDetailsService,
    ...
    protected void doFilterInternal(final HttpServletRequest request,
        ...
        final String username = dhiaTokenService.validateTokenAndGetUsername(token);
        if (username == null) {
        ...
        try {
            userDetails = dhiaUserDetailsService.loadUserByUsername(username);
